...
<script>
        $(document).ready(function () {
            $(document).on('click', '#updateModal', function () {
                var varidsupllier = $(this).data('idpsupplier');
                var varsupplier = $(this).data('nmsupplier');
                var varptoko= $(this).data('nmtoko');
                var varnotelp = $(this).data('notelp');
                var varalamat= $(this).data('alamat');

                $('#id_supplier').val(varidsupplier);
                $('#nama_supplier').val(varpsupplier);
